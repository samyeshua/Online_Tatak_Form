    ...
    if (section === 'overview') {
        ...
        contentDiv.innerHTML = `
            <div class="stats-grid">
                <div class="stat-card"><div class="stat-icon icon-blue"><i class="far fa-calendar"></i></div><div class="stat-data"><span class="value">18</span><p class="label">Total Events</p></div></div>
                <div class="stat-card"><div class="stat-icon icon-purple"><i class="fas fa-user-graduate"></i></div><div class="stat-data"><span class="value">1248</span><p class="label">Total Students</p></div></div>
                <div class="stat-card"><div class="stat-icon icon-orange"><i class="fas fa-chart-line"></i></div><div class="stat-data"><span class="value">92%</span><p class="label">Avg Attendance</p></div></div>
                <div class="stat-card"><div class="stat-icon icon-pink"><i class="fas fa-user-shield"></i></div><div class="stat-data"><span class="value">10</span><p class="label">Active Officers</p></div></div>
                <div class="stat-card"><div class="stat-icon icon-green"><i class="fas fa-university"></i></div><div class="stat-data"><span class="value">9</span><p class="label">Active Orgs</p></div></div>
            </div>
            <div class="content-grid">
                <div class="chart-container"><h3>Monthly Attendance Rate</h3><div class="chart-placeholder"></div></div>
                <div class="events-container"><h3>Upcoming Events</h3><div class="event-list"></div></div>
            </div>`;
    } 
